package com.sheepshop.businessside.zxing.android;
...
import com.sheepshop.businessside.zxing.ZxingConfig;
import com.sheepshop.businessside.zxing.camera.CameraManager;
import com.sheepshop.businessside.zxing.common.Constant;
import com.sheepshop.businessside.zxing.decode.DecodeImgCallback;
import com.sheepshop.businessside.zxing.decode.DecodeImgThread;
import com.sheepshop.businessside.zxing.decode.ImageUtil;
import com.sheepshop.businessside.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == Constant.FLASH_OPEN) {
            ...
            flashLightIv.setImageResource(R.drawable.camera_close);
    ...
    public void handleDecode(Result rawResult) {
        ...
        Call<BaseResp<BeanRespReqEmpty>> call = HttpUtils.getInstance().getApiService(ApiService.class).doVerification(rawResult.getText(), String.valueOf(bdId));
...
//                Log.d(TAG, "2" + message);
//                Log.d(TAG, "2" + rawResult.getText());
//                Log.d(TAG, "2" + String.valueOf(bdId));
