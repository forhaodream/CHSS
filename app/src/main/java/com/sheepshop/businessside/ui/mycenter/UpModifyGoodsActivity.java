...
public class UpModifyGoodsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView mEditOriginalPrice;
    private TextView mEditSpecification;
    private SwitchView mInfiniteSwitch;
    private TextView mEditRepertory;
    private SwitchView mAutoSwitch;
    private TextView mEditRepertoryMax;
    private TextView mEditBoxes;
    private TextView mEditBoxesPrice;
    private SwitchView mEliteSwitch;
    private TextView mTextTag;
    private Button mBtnSavePutaway;
    private UpModifyGoodsActivity me;
